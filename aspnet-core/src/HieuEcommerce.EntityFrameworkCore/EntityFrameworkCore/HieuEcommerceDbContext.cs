...
public class HieuEcommerceDbContext :
    AbpDbContext<HieuEcommerceDbContext>,
    IIdentityDbContext,
    ITenantManagementDbContext
{
    ...
    public HieuEcommerceDbContext(DbContextOptions<HieuEcommerceDbContext> options)
        : base(options)
    {
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        //{
        //    b.ToTable(HieuEcommerceConsts.DbTablePrefix + "YourEntities", HieuEcommerceConsts.DbSchema);
