using HieuEcommerce.Admin.Products.Attributes;
...

{
       ...
       CreateUpdateProductDto>, IProductAppService
    {
        ...
        public override async Task<ProductDto> UpdateAsync(Guid id, CreateUpdateProductDto input)
        {
            ...
            if (product == null)
                throw new BusinessException(HieuEcommerceDomainErrorCodes.ProductIsNotExists);
        ...
        public async Task<ProductAttributeValueDto> AddProductAttributeAsync(AddUpdateProductAttributeDto input)
        {
            ...
            if (attribute == null)
                throw new BusinessException(HieuEcommerceDomainErrorCodes.ProductAttributeIdIsNotExists);
            ...
            switch (attribute.DataType)
            {
                case AttributeType.Date:
                    ...
                    {
                        throw new BusinessException(HieuEcommerceDomainErrorCodes.ProductAttributeValueIsNotValid);
                    }
