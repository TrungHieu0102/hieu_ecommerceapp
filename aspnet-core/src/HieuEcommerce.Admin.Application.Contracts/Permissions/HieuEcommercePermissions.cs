...
public static class HieuEcommercePermissions
{
    public const string SystemGroupName = "HieuEcomAdminSystem";
    public const string CatalogGroupName = "HieuEcomAdminCatalog";
